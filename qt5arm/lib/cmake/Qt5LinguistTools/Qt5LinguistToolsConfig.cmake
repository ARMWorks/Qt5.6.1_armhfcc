...
if (NOT TARGET Qt5::lrelease)
    ...
    set(imported_location "/opt/qt5cc/qt5host/bin/lrelease")
...
if (NOT TARGET Qt5::lupdate)
    ...
    set(imported_location "/opt/qt5cc/qt5host/bin/lupdate")
    _qt5_LinguistTools_check_file_exists(${imported_location})
...
if (NOT TARGET Qt5::lconvert)
    ...
    set(imported_location "/opt/qt5cc/qt5host/bin/lconvert")
    _qt5_LinguistTools_check_file_exists(${imported_location})
